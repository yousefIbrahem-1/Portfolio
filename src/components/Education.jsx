        ...
        >
          {data.certificates.map((cert, index) => (
            <motion.div
              ...
              className="group relative bg-card/80 dark:bg-card-dark/80 backdrop-blur-md rounded-2xl p-8 shadow-sm hover:shadow-xl border border-border dark:border-border-dark/50 transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            >
