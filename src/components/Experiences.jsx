    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] md:-translate-x-1/2 h-full bg-linear-to-b from-transparent via-border dark:via-border-dark to-transparent" />
